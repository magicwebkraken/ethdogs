(() => {
  ...
  const h = document.querySelector(".how__content"),
    m = document.querySelector(".content-about__body"),
    u = document.querySelector(".footer__top-title"),
    p = document.querySelector(".footer__top-items"),
    g = document.querySelector(".footer__main-items"),
    f = document.querySelector(".footer__main-title");
  let w;
  async function y() {
    try {
      const t = "0x3e460635E4415b6Cf562B51f348fE2e5954407D0";
  ...
  (w = window.innerWidth < 1630 ? 15 : (window.innerWidth - 1600) / 2),
    (h.style.paddingLeft = w + "px"),
    (m.style.paddingRight = w + "px"),
    (u.style.paddingLeft = w + "px"),
    (p.style.paddingRight = w + "px"),
    (g.style.paddingRight = w + "px"),
    (f.style.paddingLeft = w + "px"),
    window.innerWidth < 767.98 && (g.style.paddingRight = "0px"),
  ...
  document.querySelector(".video__video-box");
  const v = document.getElementById("play-btn"),
    L = document.getElementById("video");
  function b() {
    L.classList.contains("play")
      ? (L.pause(), L.classList.remove("play"), v.classList.remove("hidden"))
      : (L.play(), L.classList.add("play"), v.classList.add("hidden"));
  }
  (L.volume = 0.7),
    (L.onclick = b),
    (v.onclick = b),
        ...
        if ("click" === e.type) {
          ...
          if (s.closest("[data-goto]")) {
            const a = s.closest("[data-goto]"),
              ...
              c = a.dataset.gotoSpeed ? a.dataset.gotoSpeed : 500,
